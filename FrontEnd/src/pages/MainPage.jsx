                        ...
                        <div className="row">
                            <div className="descrInfoGrado col-lg-8">
                                <div className="tituloSeccion">
                                    <h2>La hoja de ruta para una digitalización global y efectiva</h2>
                                </div>
                                <p>
                                    ¿Sabes que la
                                    <strong>integración de las tecnologías digitales</strong> (big
                                    data, inteligencia artificial, marketing digital…) puede ayudarte
                                    a&nbsp;
                                    <strong>aumentar significativamente la competitividad</strong>
                                    &nbsp;de tu empresa?
                                </p>
                                <p>
                                    Si tienes interés en accionar la palanca de la digitalización y
                                    diseñar una&nbsp;estrategia a medida para tu organización, el
                                    nuevo
                                    <strong>programa de Transformación Digital para la PYME</strong>
                                    está hecho para ti.
                                </p>
                                <p>
                                    Este es un programa
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 destacadoInfoGrado">
                                        ...
                                        />
                                        <h3>Duración</h3>
                                        <p>136 horas de formación presencial o en presencia virtual.</p>
                                    </div>
                                    <div className="col-lg-6 destacadoInfoGrado">
                                        <img
                                            width={76}
                                        ...
                                        <p>
                                            ...
                                            fiananciado por la Unión Europea Next Generation EU | Plan de
                                            Recuperación y Resiliencia del Gobierno de España.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="descrInfoGrado col-lg-8">
                                ...
                                <div className="row">
                                    <div className="col-lg-6 destacadoInfoGrado">
                                        ...
                                        <p>
                                            Desempeñas una
                                            <strong>función directiva dentro de una PYME </strong>(con una
                                            plantilla de entre 10 y 249 personas) ubicada en el País
                                            Vasco.
                                        </p>
                                    </div>
                                    <div className="col-lg-6 destacadoInfoGrado">
                                        ...
                                        <p>
                                            Buscas
                                            <strong>
                                                conocer la realidad de otras organizaciones y profesionales
                                            </strong>
                                            para contrastarla con tu experiencia e inspirarte de cara al
                                            futuro.
                                        </p>
                                    </div>
                                    <div className="col-lg-6 destacadoInfoGrado">
                                ...
                                >
                                    <div className="owl-item active" style={{ width: "auto" }}>
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    Conoce las herramientas y procesos&nbsp;que te permitirán
                                                    abordar una transformación tecnológica integral en tu
                                                    organización.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="owl-item" style={{ width: "auto" }}>
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    Integra las tecnologías&nbsp;que te permitirán innovar y
                                        ...
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    ...
                                                    áreas de la empresa y forme parte del ADN de las personas
                                                    que la conforman.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="owl-item" style={{ width: "auto" }}>
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    Genera sinergias y mejora la comunicación entre diferentes
                                                    áreas funcionales.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    ...
                                                    efectiva&nbsp;con potenciales usuarios y para fidelizar a
                                    ...
                                    <div className="owl-item" style={{ width: "auto" }}>
                                        <div className="razonBox">
                                            ...
                                            <div>
                                                <p>
                                                    Diseña un plan de transformación digital&nbsp; a medida
                                                    para tu empresa.
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-md-6 cifraBox">
                                ...
                                <p>Proyecto de emprendimiento de aplicación real y tutorizado</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="inscripcion" className="caracteristicasAlumno">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-5" id="acordeonAlumnoProcesodeinscripcionEOI">
                                ...
                                <div className="bloqueAcordeon">
                                    ...
                                    >
                                        <p>
                                            Solicita tu bono de formación a través del siguiente enlace:
                                        </p>
                                        <p>
                                            <a
                                                className="enlaceFlechaAzul"
